    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AppUserAddressId = table.Column<string>(nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserAddress", x => x.AppUserAddressId);
                    table.ForeignKey(
                        name: "FK_AppUserAddress_AspNetUsers_AppUserAddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PhoneNumbers_AspNetUsers_PhoneNumberId",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(nullable: false),
                    LoanCategoryId = table.Column<string>(nullable: true),
                    LoanCompanyId = table.Column<string>(nullable: true),
                    InterestRate = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Loans_LoanCompanies_LoanCompanyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserLoans", x => new { x.AppUserId, x.LoanId });
                    table.ForeignKey(
                        name: "FK_AppUserLoans_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppUserLoans_Loans_LoanId",
                        column: x => x.LoanId,
